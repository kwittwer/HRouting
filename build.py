...
def build_exe(version: str) -> Path:
    ...
    cmd = [
        ...
        # MCP-Server-Abhängigkeiten – collect-submodules für dynamische Pakete
        ...
        "--collect-submodules", "referencing",
        "--hidden-import", "h11",
        ...
        "--hidden-import", "attr",
        "--hidden-import", "attrs",
        # Metadaten für entry-point Discovery (pydantic, mcp)
        ...
        "--copy-metadata", "python-multipart",
