...
ELEC_POINT_SCHEMA = ElementSchema(
    ...
    fields=(
        *_common_fields("#4fc3f7"),
        ...
        FieldSpec("kicad_group_uuid", "KiCad Gruppen-UUID", FieldKind.READONLY,
                  default="", group="KiCad-Sync"),
        FieldSpec("kicad_frame_uuid", "KiCad Rahmen-UUID", FieldKind.READONLY,
                  default="", group="KiCad-Sync"),
        FieldSpec("kicad_sheet_path", "KiCad Sheet-Datei", FieldKind.READONLY,
                  default="", group="KiCad-Sync"),
        FieldSpec("kicad_last_import_hash", "KiCad Import-Hash", FieldKind.READONLY,
                  default="", group="KiCad-Sync"),
        FieldSpec("kicad_last_imported_at", "KiCad zuletzt importiert", FieldKind.READONLY,
                  default="", group="KiCad-Sync"),
        *_label_fields(),
    ),
    actions=(
...
ELEC_CABLE_SCHEMA = ElementSchema(
    ...
    fields=(
        *_common_fields("#ff9800"),
        ...
        FieldSpec("end_ap", "End-AP", FieldKind.CHOICE,
                  document_options=_elec_point_id_options, default="",
                  group="Verbindungen"),
        FieldSpec("start_length_surcharge_m", "Aufschlag Start", FieldKind.NUMBER,
                minimum=0.0, maximum=9999.0, step=0.1, decimals=2, unit="m",
                default=0.0, group="Verbindungen"),
        FieldSpec("end_length_surcharge_m", "Aufschlag Ende", FieldKind.NUMBER,
                minimum=0.0, maximum=9999.0, step=0.1, decimals=2, unit="m",
                default=0.0, group="Verbindungen"),
        ...
        FieldSpec("kicad_project_uuid", "KiCad Projekt-UUID", FieldKind.READONLY,
                  default="", group="KiCad-Sync"),
        FieldSpec("kicad_sheet_uuid", "KiCad Sheet-UUID", FieldKind.READONLY,
                  default="", group="KiCad-Sync"),
        FieldSpec("kicad_pin_uuid", "KiCad Pin-UUID", FieldKind.READONLY,
                  default="", group="KiCad-Sync"),
        FieldSpec("kicad_pin_name", "KiCad Pinname", FieldKind.READONLY,
                  default="", group="KiCad-Sync"),
        FieldSpec("kicad_sheet_path", "KiCad Sheet-Datei", FieldKind.READONLY,
                  default="", group="KiCad-Sync"),
        FieldSpec("kicad_cable_key", "KiCad Kabelschlüssel", FieldKind.READONLY,
                  default="", group="KiCad-Sync"),
        FieldSpec("kicad_last_import_hash", "KiCad Import-Hash", FieldKind.READONLY,
                  default="", group="KiCad-Sync"),
        FieldSpec("kicad_last_imported_at", "KiCad zuletzt importiert", FieldKind.READONLY,
    ...
    computed=(
        ("path_length_m", "Planlänge"),
        ("start_surcharge_m", "Aufschlag Start"),
        ("end_surcharge_m", "Aufschlag Ende"),
        ("length_m", "Gesamtlänge"),
        ("start_ap_name", "Start"),
        ("end_ap_name", "Ziel"),
    ),
)
